...
//        String xml = """
//                <server class='livonia.xml.testXML$Server'>
//                  <service class='livonia.xml.testXML$Service' name='http'>
//                    <connector class='livonia.xml.testXML$Connector' port='8080'/>
//                  </service>
//                </server>""";
//
...
//        System.out.println(d.pop());
        ...
        try (InputStream in = Files.newInputStream(Path.of("/Users/lilinjian/IdeaProjects/myWebServer/web/src/main/java/livonia/xml/exampleWebXML.xml"))) {
            digester.parse(in);
